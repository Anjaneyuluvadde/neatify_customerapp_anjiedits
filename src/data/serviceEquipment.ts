...
export const SERVICE_EQUIPMENT = {
  BATHROOM: {
    ...
    items: [
      ...
      { name: "Microfiber Cloth", icon: "tshirt-crew" },
      { name: "Disinfectant Spray", icon: "bottle-tonic-plus" },
      { name: "Scrub Sponge", icon: "washing-machine" },
  ...
  KITCHEN: {
    ...
    items: [
      { name: "Kitchen Scrubber", icon: "brush" },
      { name: "Degreaser Spray", icon: "bottle-tonic-plus" },
      { name: "Microfiber Cloth", icon: "tshirt-crew" },
      { name: "Sponge", icon: "washing-machine" },
  ...
  SOFA: {
    ...
    items: [
      ...
      { name: "Extraction Machine", icon: "washing-machine" },
      { name: "Microfiber Cloth", icon: "tshirt-crew" },
  ...
  BALCONY: {
    ...
    items: [
      ...
      { name: "Deep Cleaner", icon: "washing-machine" },
    ],
  },
  EXPRESS_HOME: {
    ...
    items: [
      ...
      { name: "Scrubber", icon: "washing-machine" },
